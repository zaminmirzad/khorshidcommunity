...
const ACTIVITY = [
  { text: 'You registered for Summer Cultural Festival', time: '2 days ago' },
  { text: 'Your profile was updated', time: '5 days ago' },
  { text: 'You attended Persian Language Workshop', time: '2 weeks ago' },
  { text: 'You joined Khorshid Community', time: '5 years ago' },
];
    ...
    <div className="space-y-8">
      <div>
        ...
        <h1 className="font-display font-light text-3xl sm:text-4xl text-gray-900 dark:text-white">
          Good morning, <em className="italic text-brand-900 dark:text-brand-300">Ahmad</em>
        </h1>
      ...
      <div className="bg-gradient-to-br from-brand-950 via-brand-900 to-brand-950 rounded-2xl p-6 sm:p-8 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-brand-400 text-sm">Active since 2021 · Free membership</p>
          </div>
