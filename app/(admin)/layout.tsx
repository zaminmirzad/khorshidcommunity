...
const NAV_ITEMS = [
  ...
  { href: '/admin/messages', label: 'Messages', badge: 4, icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg> },
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.badge && <span className="w-5 h-5 rounded-full bg-red-500 text-white text-[10px] font-bold flex items-center justify-center shrink-0">{item.badge}</span>}
              {isActive && !item.badge && <span className="w-1.5 h-1.5 rounded-full bg-accent shrink-0" />}
            </Link>
          );
        })}
      </nav>
      ...
      <div className="px-4 py-4 border-t border-white/8 relative z-10">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-red-800 to-red-900 border border-red-500/30 flex items-center justify-center shrink-0">
            <span className="font-display text-sm font-semibold text-red-300">Z</span>
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-white text-sm font-semibold leading-none mb-0.5 truncate">Zamin Mirzad</p>
        ...
        <div className="flex-1 flex flex-col min-w-0 lg:pl-64">
          <header className="sticky top-0 z-30 h-16 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 flex items-center gap-4 px-6 shrink-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-red-800 to-red-900 border border-red-200 dark:border-red-900 flex items-center justify-center cursor-pointer">
                <span className="font-display text-xs font-semibold text-red-300">Z</span>
              </div>
            </div>
          </header>
