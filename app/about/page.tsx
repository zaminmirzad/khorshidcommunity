  ...
  return (
    <div className="text-center mb-14">
      <span className="inline-flex items-center gap-3 text-accent-dark font-semibold uppercase text-[11px] tracking-[0.2em] mb-5">
        <span className="w-10 h-px bg-accent" />{overline}<span className="w-10 h-px bg-accent" />
      </span>
  ...
  return (
    <div className="bg-surface">
      <PageHero
        ...
        title={<>Preserving Heritage,<br /><em className="italic text-accent-muted">Building Futures</em></>}
      ...
      <section className="py-24 bg-surface-alt">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          <span className="inline-flex items-center gap-3 text-accent-dark font-semibold uppercase text-[11px] tracking-[0.2em] mb-6">
            <span className="w-10 h-px bg-accent" />Our Story<span className="w-10 h-px bg-accent" />
          </span>
      ...
      <section className="py-24 bg-surface">
        <div className="container mx-auto px-6 max-w-6xl">
          <SectionHeader overline="Our Purpose" title={<>Mission & <em className="italic text-brand-900">Vision</em></>} />
            ...
            {[
              ...
              <div key={card.title} className="group bg-surface-alt rounded-2xl p-8 border border-gray-100 hover:border-accent-light hover:shadow-xl transition-all duration-500">
                <div className="w-14 h-14 bg-brand-900 group-hover:bg-brand-800 rounded-2xl flex items-center justify-center mb-6 transition-colors">
                  <svg className="w-7 h-7 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">{card.icon}</svg>
                </div>
        ...
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <div className="text-center mb-14">
            <span className="inline-flex items-center gap-3 text-accent/80 font-semibold uppercase text-[11px] tracking-[0.2em] mb-5">
              <span className="w-10 h-px bg-accent/50" />What We Stand For<span className="w-10 h-px bg-accent/50" />
            </span>
      ...
      <section className="py-24 bg-surface-alt">
        <div className="container mx-auto px-6 max-w-4xl">
          <SectionHeader overline="Our Journey" title={<>Key <em className="italic text-brand-900">Milestones</em></>} />
      ...
      <section className="py-24 bg-surface">
        <div className="container mx-auto px-6 max-w-5xl">
          <SectionHeader overline="Our Roadmap" title={<>Strategic Goals <em className="italic text-brand-900">2025–2028</em></>} />
      ...
      <section className="py-24 bg-surface-alt">
        <div className="container mx-auto px-6 max-w-6xl">
          <SectionHeader overline="Our Leaders" title={<>Meet the <em className="italic text-brand-900">Team</em></>} />
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="text-center md:text-left flex-1">
                <span className="inline-flex items-center gap-2 text-accent-dark font-semibold uppercase text-[11px] tracking-[0.15em] mb-3">
                  <span className="w-6 h-px bg-accent" />President
                </span>
      ...
      <section className="py-24 relative overflow-hidden bg-gradient-to-br from-brand-900 via-brand-950 to-brand-950">
        ...
        <div className="absolute -bottom-32 right-0 w-[400px] h-[400px] rounded-full bg-brand-400/10 blur-[100px] pointer-events-none" />
        <div className="container mx-auto px-6 max-w-3xl text-center text-white relative z-10">
          <div className="relative z-10">
            ...
            <p className="text-brand-300 text-base mb-9 max-w-xl mx-auto leading-relaxed">
