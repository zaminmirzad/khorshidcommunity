    ...
    <div className="bg-white">
      ...
      <div className="container mx-auto px-6 py-20 max-w-7xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-20">
          {[
            { icon: "📞", title: "Call Us", info: "+1 (619) 882-7406", detail: "Mon-Fri, 9AM-6PM", action: "Call Now", link: "tel:+15556782345" },
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            {/* FIX: Google Maps corrected to San Diego coordinates */}
            ...
            <div className="bg-gradient-to-r from-blue-900 to-blue-950 rounded-3xl p-8 text-white">
              ...
              <div className="flex gap-4">
                {[
                  { name: "Instagram", icon: "📷", color: "hover:bg-pink-600", href: "https://www.instagram.com/khorshidcommunity" },
                  { name: "Facebook", icon: "📘", color: "hover:bg-blue-600", href: "https://www.facebook.com/khorshidcommunity" },
                  { name: "YouTube", icon: "▶️", color: "hover:bg-red-600", href: "https://www.youtube.com/@khorshidcommunity" },
                  { name: "Twitter", icon: "🔗", color: "hover:bg-blue-700", href: "https://twitter.com/khorshidcommunity" },
                ].map((social, idx) => (
                  <a
                    key={idx}
                    href={social.href}
                    ...
                    className={`flex-1 py-2 bg-white/10 rounded-xl ${social.color} transition-all hover:scale-105 text-center`}
                  >
