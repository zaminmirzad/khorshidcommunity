// app/events/page.tsx - Navy Blue & Gold Theme
        ...
        <div className="space-y-10 max-w-5xl mx-auto">
          {events.map((event) => (
            <div key={event.id} className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col md:flex-row">
              {/* Fixed height image container - same height for all images */}
              <div className="md:w-1/3 h-64 md:h-64 overflow-hidden bg-gradient-to-br from-blue-800 to-blue-900 flex-shrink-0">
                <img 
                  src={event.image} 
                  alt={event.title} 
