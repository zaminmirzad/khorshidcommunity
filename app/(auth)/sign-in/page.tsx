...
export default function SignInPage() {
  ...
  async function handleCredentials(e: React.FormEvent) {
    ...
    // Password correct — clear session and send OTP
            ...
            {step === 'credentials' ? (
              ...
              <>
                <div className="mb-8">
                  ...
                  <span className="inline-flex items-center gap-2.5 text-accent-dark font-semibold uppercase text-[10px] tracking-[0.2em] mb-4">
                    <span className="w-5 h-px bg-accent" />Verification
                  </span>
                  <h1 className="font-display font-light text-3xl text-gray-900 leading-tight">
                    Check your<br /><em className="italic text-brand-900">email</em>
                  </h1>
                ...
                <div className="mt-6 flex items-center justify-between">
                  ...
                  <button
                    ...
                    disabled={resending}
                    className="text-xs font-semibold text-accent-dark hover:text-accent transition-colors disabled:opacity-50"
                  >
