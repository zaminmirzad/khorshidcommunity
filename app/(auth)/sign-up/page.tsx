    ...
    <div className="mt-2.5 space-y-2">
      <div className="flex gap-1">
        {[0, 1, 2, 3].map((i) => (
          <div
            key={i}
            className={`h-1 flex-1 rounded-full transition-all duration-300 ${i < score ? barColors[score - 1] : 'bg-gray-200'}`}
          />
        ))}
      </div>
          ...
          <div className="bg-white/85 backdrop-blur-xl rounded-3xl shadow-2xl shadow-gray-300/40 border border-white/80 p-8 sm:p-10">
            ...
            <div className="mb-7">
              <span className="inline-flex items-center gap-2.5 text-accent-dark font-semibold uppercase text-[10px] tracking-[0.2em] mb-4">
                <span className="w-5 h-px bg-accent" />Create Account
              </span>
              <h1 className="font-display font-light text-4xl text-gray-900 leading-tight">
                Join our<br /><em className="italic text-brand-900">community</em>
              </h1>
            </div>
            ...
            <form className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[11px] font-semibold uppercase tracking-[0.1em] text-gray-400 mb-2">First Name</label>
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      placeholder="Farida"
                      className="w-full pl-10 pr-3 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl text-gray-900 text-sm placeholder:text-gray-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-accent/30 focus:border-accent/50 transition-all duration-200"
                    />
                  </div>
                </div>
                <div>
                  <label className="block text-[11px] font-semibold uppercase tracking-[0.1em] text-gray-400 mb-2">Last Name</label>
                  <input
                    type="text"
                    placeholder="Ahmadi"
                    className="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl text-gray-900 text-sm placeholder:text-gray-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-accent/30 focus:border-accent/50 transition-all duration-200"
                  />
                </div>
              </div>
              ...
              {/* Password */}
              <div>
                <label className="block text-[11px] font-semibold uppercase tracking-[0.1em] text-gray-400 mb-2">Password</label>
                <div className="relative">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none">
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                <input
                  ...
                  className="w-4 h-4 rounded border-gray-300 accent-amber-400 mt-0.5 shrink-0"
                />
                <span className="text-sm text-gray-500 leading-relaxed select-none group-hover:text-gray-700 transition-colors">
                  I agree to the{' '}
                  <span className="text-accent-dark font-semibold cursor-pointer hover:underline">Terms of Service</span>
                  {' '}and{' '}
                  <span className="text-accent-dark font-semibold cursor-pointer hover:underline">Privacy Policy</span>
                </span>
              </label>
              ...
              <button
                type="submit"
                disabled={!agreed}
                className="btn-shimmer w-full bg-accent hover:bg-accent-hover disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed disabled:shadow-none text-brand-950 font-semibold py-4 rounded-2xl transition-all duration-300 text-sm tracking-wide shadow-[0_8px_30px_rgba(251,191,36,0.3)] hover:shadow-[0_8px_40px_rgba(251,191,36,0.5)] hover:-translate-y-0.5 disabled:transform-none"
              >
                Create Free Account →
              </button>
            </form>
            ...
            <p className="mt-7 text-center text-sm text-gray-500">
              ...
              <Link href="/sign-in" className="text-accent-dark font-semibold hover:text-accent transition-colors">
                Sign in
              </Link>
            </p>
          </div>
